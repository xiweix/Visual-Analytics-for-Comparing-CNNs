...
for model_name in full_model_list:
    ...
    for i in range(len(total_acc)):
        ...
        if i < 1000:
            ...
            curSize = 12
        info = '        { id: ' + str(i) + ', name: \'' + curLabelName + '\', _color: \'' + curColor + '\', _size: ' + str(curSize) + ', accuracy: ' + str(curAcc) + ' },\n'
        with open(write_path, 'a') as ftxt:
            ftxt.write(info)
    info = '        { id: ' + str(len(total_acc)) + ', name: \'' + 'ImageNet' + '\', _color: \'' + 'rgba(73,133,183,0.45)' + '\', _size: ' + str(6) + ' }\n'
    with open(write_path, 'a') as ftxt:
        ftxt.write(info)
        ftxt.write('      ],\n')
    ...
    for i in range(len(total_id)):
        ...
        if i < 1571:
            ...
            for parID in parIDs:
                end = IDtoIdx(dataset_path, parID)
